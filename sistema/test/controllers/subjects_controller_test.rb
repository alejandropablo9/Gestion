...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { grade_id: @subject.grade_id, nombre: @subject.nombre } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { grade_id: @subject.grade_id, nombre: @subject.nombre } }
